...
@Version 2.1.8
1. Fixed the WBR:News widget and WBR:page widget style issues.
2. Fixed the footer widget section layout issue in responsive view.
@Version 2.1.7
1. Fixed the News and footer sections empty markup issues.
