 ...
 */
function bloz_sanitize_checkbox( $checked ) {
	// Boolean check.
 ...
 *
 */
function bloz_sanitize_hex_color( $hex_color, $setting ) {
 ...
 */
function bloz_sanitize_image( $image, $setting ) {
	/*
 ...
 */
function bloz_sanitize_select( $input, $setting ) {
 ...
 * 
 */
function bloz_sanitize_dropdown_pages( $page_id, $setting ) {
 ...
 * 
 */
function bloz_sanitize_number_range( $number, $setting ) {
 ...
 */
function bloz_sanitize_html( $html ) {
 ...
 */
function bloz_sanitize_sort( $input ) {
