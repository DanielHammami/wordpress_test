...
function bookacti_settings_section_system_callback() {
	...
	<div id='bookacti-archive-alert-messages' style='display:none;'>
		<span id='booakcti-archive-alert-analyse'><?php echo esc_html__( 'The bookings and events data prior to {date} will be saved to a SQL file and deleted from your database. You will be able to restore your data afterwards.', 'booking-activities' ) . '\n\n/!\\ '  . esc_html__( 'We still strongly advise you to backup your database before proceeding.', 'booking-activities' ) . '\n\n' . esc_html__( 'Do you want to archive your data now?', 'booking-activities' ); ?></span>
		<span id='booakcti-archive-alert-override'><?php echo esc_html__( 'An archive already exists for this date. The existing backup files will be removed and replaced with the new ones.', 'booking-activities' ) . '\n\n' . esc_html__( 'Do you want to archive your data now?', 'booking-activities' ); ?></span>
		<span id='booakcti-archive-alert-restore'><?php echo esc_html__( 'The data contained in {filename} will be added to your database. You should do this only once.', 'booking-activities' ) . '\n\n' . esc_html__( 'Do you want to restore these data now?', 'booking-activities' ); ?></span>
		<span id='booakcti-archive-alert-delete-file'><?php echo esc_html__( 'The backup file {filename} will be permanently deleted. This action cannot be undone.', 'booking-activities' ) . '\n\n' . esc_html__( 'Do you want to permanently delete this file?', 'booking-activities' ); ?></span>
	</div>
	<?php
}
