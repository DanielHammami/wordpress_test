...
$selective_refresh = isset( $wp_customize->selective_refresh ) ? 'postMessage' : 'refresh';
	 ...
	 */
		...
		class StoreBiz_testimonial_section_upgrade extends WP_Customize_Control {
			...
			?>
				<span class="customizer_StoreBiz_testimonial_upgrade_section up-to-pro" style="display: none;"><?php _e('More Testimonial Available in StoreBiz Pro','storebiz'); ?></span>
