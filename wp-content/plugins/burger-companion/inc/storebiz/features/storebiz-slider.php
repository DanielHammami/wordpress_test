...
$selective_refresh = isset( $wp_customize->selective_refresh ) ? 'postMessage' : 'refresh';
	 ...
	 */
		...
		class Storebiz_slider_section_upgrade extends WP_Customize_Control {
			...
			?>
				<span class="customizer_StoreBiz_slider_upgrade_section up-to-pro" style="display: none;"><?php _e('More Slides Available in StoreBiz Pro','storebiz'); ?></span>
	 ...
	 */
		...
		$wp_customize->add_control( 
			new Burger_Companion_Repeater( $wp_customize, 
				'slider_right_info', 
					array(
						'label'   => esc_html__('Info','storebiz'),
						'section' => 'slider_setting',
						'add_field_label'                   => esc_html__( 'Add New', 'storebiz' ),
						'item_name'                         => esc_html__( 'Info', 'storebiz' ),
