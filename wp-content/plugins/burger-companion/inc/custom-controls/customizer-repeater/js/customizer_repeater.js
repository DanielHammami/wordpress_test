...
jQuery(document).ready(function () {
    ...
    burger_companion_theme_controls.on('click', '.customizer-repeater-new-field', function () {
		...
		if(split_add_more_button_split=="Add New Slid")
        {
			if(jQuery('#exist_burger_companion_StoreBiz_Slider').val()>=3)
				{
            ...
            if(jQuery('#exist_burger_companion_StoreBiz_Slider').val()<3)
				{
					var new_service_add_val=parseInt(jQuery('#exist_burger_companion_StoreBiz_Slider').val())+1;
					jQuery('#exist_burger_companion_StoreBiz_Slider').val(new_service_add_val);  
				}
        }
		...
		if(split_add_more_button_split=="Add New Test")
        {
			if(jQuery('#exist_burger_companion_StoreBiz_Testimonial').val()>=3)
				{
			 ...
			 if(jQuery('#exist_burger_companion_StoreBiz_Testimonial').val()<3)
				{
					var new_service_add_val=parseInt(jQuery('#exist_burger_companion_StoreBiz_Testimonial').val())+1;
					jQuery('#exist_burger_companion_StoreBiz_Testimonial').val(new_service_add_val);  
				}
        }
    ...
    burger_companion_theme_controls.on('click', '.social-repeater-general-control-remove-field', function () {
        ...
        if (typeof    jQuery(this).parent() !== 'undefined') {
            jQuery(this).parent().hide(500, function(){
				...
				if(split_delete_button_split=="Delete Slide")
                {
                jQuery('#exist_burger_companion_StoreBiz_Slider').val(parseInt(jQuery('#exist_burger_companion_StoreBiz_Slider').val())-1);  
                }
				
				if(split_delete_button_split=="Delete Testi")
                {
                jQuery('#exist_burger_companion_StoreBiz_Testimonial').val(parseInt(jQuery('#exist_burger_companion_StoreBiz_Testimonial').val())-1); 
                }
            });
        }
        return false;
